...
import com.aps.services.user.model.dto.AuthenticationRequestDto;
...
public class JwtAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    @Autowired
    public JwtAuthenticationFilter(AuthenticationManager authManager, UserJwtConfig userJwtConfig, TokenUtility tokenUtility) {
